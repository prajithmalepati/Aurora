...
## Document 8 of 12 | For: Qwen (Cline) + Human Review
...
Without it, Qwen will write `fetch("http://localhost:8000/api/songs")` with inline error handling in every single component. This centralizes:
