...
## Document 7 of 12 | For: Qwen (Cline) + Human Review
...
**TypeScript over JavaScript:** Aurora has interconnected state (songs reference tags and playlists). TS catches mismatched shapes between API responses and frontend models at build time. Qwen generates TypeScript well. The extra setup is 2 minutes; the bug prevention is permanent.
...
## Cline Rules for Frontend Tasks

Paste these into Cline's rules/instructions:
